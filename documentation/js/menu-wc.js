                    ...
                    <li class="chapter modules">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            <li class="link">
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#controllers-links-module-AppModule-a331cdab81e53b117fce583bcb6a6a8b"' : 'data-target="#xs-controllers-links-module-AppModule-a331cdab81e53b117fce583bcb6a6a8b"' }>
                                            <span class="icon ion-md-swap"></span>
                                            <span>Controllers</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="controllers-links-module-AppModule-a331cdab81e53b117fce583bcb6a6a8b"' :
                                            'id="xs-controllers-links-module-AppModule-a331cdab81e53b117fce583bcb6a6a8b"' }>
                                            <li class="link">
                                ...
                                <li class="chapter inner">
                                    <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                        'data-target="#injectables-links-module-AppModule-a331cdab81e53b117fce583bcb6a6a8b"' : 'data-target="#xs-injectables-links-module-AppModule-a331cdab81e53b117fce583bcb6a6a8b"' }>
                                        <span class="icon ion-md-arrow-round-down"></span>
                                        <span>Injectables</span>
                                        <span class="icon ion-ios-arrow-down"></span>
                                    </div>
                                    <ul class="links collapse" ${ isNormalMode ? 'id="injectables-links-module-AppModule-a331cdab81e53b117fce583bcb6a6a8b"' :
                                        'id="xs-injectables-links-module-AppModule-a331cdab81e53b117fce583bcb6a6a8b"' }>
                                        <li class="link">
                            ...
                            <li class="link">
                                <a href="modules/TodoModule.html" data-type="entity-link">TodoModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#controllers-links-module-TodoModule-b66220f27c16ad7e44a9d5181f572ad1"' : 'data-target="#xs-controllers-links-module-TodoModule-b66220f27c16ad7e44a9d5181f572ad1"' }>
                                            <span class="icon ion-md-swap"></span>
                                            <span>Controllers</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="controllers-links-module-TodoModule-b66220f27c16ad7e44a9d5181f572ad1"' :
                                            'id="xs-controllers-links-module-TodoModule-b66220f27c16ad7e44a9d5181f572ad1"' }>
                                            <li class="link">
                                ...
                                <li class="chapter inner">
                                    <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                        'data-target="#injectables-links-module-TodoModule-b66220f27c16ad7e44a9d5181f572ad1"' : 'data-target="#xs-injectables-links-module-TodoModule-b66220f27c16ad7e44a9d5181f572ad1"' }>
                                        <span class="icon ion-md-arrow-round-down"></span>
                                        <span>Injectables</span>
                                        <span class="icon ion-ios-arrow-down"></span>
                                    </div>
                                    <ul class="links collapse" ${ isNormalMode ? 'id="injectables-links-module-TodoModule-b66220f27c16ad7e44a9d5181f572ad1"' :
                                        'id="xs-injectables-links-module-TodoModule-b66220f27c16ad7e44a9d5181f572ad1"' }>
                                        <li class="link">
